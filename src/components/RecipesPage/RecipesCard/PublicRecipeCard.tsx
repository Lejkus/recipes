...
export default function PublicRecipeCard({ recipe, elementloading, index, currentUser, deleteFromSaved, addToSaved }: { recipe: RecipeType, elementloading: string | null, index: number, currentUser: string | undefined, deleteFromSaved: (recipe: RecipeType) => void, addToSaved: (recipe: RecipeType) => void }) {
